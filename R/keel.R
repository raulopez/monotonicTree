...
descargar_jar <- function(){
  ...
  cat("[2] Download JAR\n\n")
  path <- file.path(system.file(package = "monotonicTree"), "download","JarFiles.rar")
  downloader::download(url="https://github.com/raulopez/monotonicTree/raw/master/jar/JarFiles.rar",destfile = path, mode ="wb")
  cat("[3] Unzip files\n")
